    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            ...
            if (sTransmogrification->EnableTransmogInfo)
                AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|tComo funciona esto?", EQUIPMENT_SLOT_END + 9, 0);
            ...
            if (sTransmogrification->EnableSets)
                AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/RAIDFRAME/UI-RAIDFRAME-MAINASSIST:30:30:-18:0|tAdministrar Set", EQUIPMENT_SLOT_END + 4, 0);
#endif
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Enchant_Disenchant:30:30:-18:0|tQuitar Transfiguraciones", EQUIPMENT_SLOT_END + 2, 0, "Seguro que deseas quitar todas las Transfiguraciones?", 0, false);
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|tActualizar la lista", EQUIPMENT_SLOT_END + 1, 0);
            ...
            switch (sender)
            {
                ...
                case EQUIPMENT_SLOT_END + 4: // Presets menu
                {
                    ...
                    if (sTransmogrification->EnableSetInfo)
                        AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|tComo funcionan los Sets", EQUIPMENT_SLOT_END + 10, 0);
                    ...
                    if (!player->presetMap.empty())
                    {
                        ...
                        if (player->presetMap.size() < sTransmogrification->MaxSets)
                            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|tGuardar Set", EQUIPMENT_SLOT_END + 8, 0);
                    }
                    else
                        AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|tGuardar Set", EQUIPMENT_SLOT_END + 8, 0);
                    AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|tRegresar...", EQUIPMENT_SLOT_END + 1, 0);
                    SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
                } break;
                ...
                case EQUIPMENT_SLOT_END + 6: // view preset
                {
                    ...
                    AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Misc_Statue_02:30:30:-18:0|tUsar Set", EQUIPMENT_SLOT_END + 5, action, "Si haces esto todo el equipo se ligara a ti y ya no podrá ser comerciado.\nDeseas continuar, insecto?\n\n" + it->second.name, 0, false);
                    AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/PaperDollInfoFrame/UI-GearManager-LeaveItem-Opaque:30:30:-18:0|tBorrar Set", EQUIPMENT_SLOT_END + 7, action, "Seguro que deseas borrar " + it->second.name + "?", 0, false);
                    AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|tRegresar...", EQUIPMENT_SLOT_END + 4, 0);
                    SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
                } break;
                ...
                case EQUIPMENT_SLOT_END + 8: // Save preset
                {
                    ...
                    if (canSave)
                        AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|tSave set", 0, 0, "Pon el nombre de tu Set", cost*sTransmogrification->SetCostModifier + sTransmogrification->SetCopperCost, true);
                    AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|tActualizar lista", sender, action);
                    AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|tRegresar...", EQUIPMENT_SLOT_END + 4, 0);
                    SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
                } break;
        ...
        void ShowTransmogItems(Player* player, Creature* creature, uint8 slot) // Only checks bags while can use an item from anywhere in inventory
        {
            ...
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Enchant_Disenchant:30:30:-18:0|tBorrar Transfiguracion", EQUIPMENT_SLOT_END + 3, slot, "Borrar Transfiguracion de la casilla actual?", 0, false);
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|tActualizar lista", EQUIPMENT_SLOT_END, slot);
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|tRegresar...", EQUIPMENT_SLOT_END + 1, 0);
            SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
        }
    };
